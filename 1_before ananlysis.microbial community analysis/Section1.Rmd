...
## 4 Microbial data analysis integrated

see single `.Rmd` file（2_Microbiome data analysis integrated class R package/pipeline）


## 5 The best practice R pipeline for microbiome data analysis


see bast.practice.all.pipeline.Rmd file (3_The best practice R pipeline in microbiome data analysis/)
